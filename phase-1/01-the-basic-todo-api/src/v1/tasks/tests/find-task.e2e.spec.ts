...
describe('TaskModule - findTask', () => {
  ...
  it(`GET - v1/tasks/:id should throw unauthorized if user is not authenticated`, async () => {
    await request(app.getHttpServer()).get('/v1/tasks/sometask').expect(401);
  });

  it(`GET - v1/tasks/:id should find task`, async () => {
